...
export type ContactUsValidationErrors = Partial<Record<keyof ContactUsFormValues, string>>;
...
export function validateTestRideForm(values: TestRideFormValues): TestRideValidationErrors {
  ...
  if (!email && !phone) {
    errors.email = "Please enter either your email or whatsapp number.";
  }
...
export function validateContactUsForm(values: ContactUsFormValues): ContactUsValidationErrors {
