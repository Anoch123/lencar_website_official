...
function SectionHeading({
  ...
  return (
    <div className="flex items-baseline gap-4">
      <span className="font-body text-[13px] font-black text-[#0F4C81]">
        {number}
      </span>
  ...
  return (
    <div>
      <AllPageHero
        ...
        imageSrc="/images/privacy_policy.png"
      />
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <ul className="mt-3 space-y-1.5 font-body text-[15px] leading-relaxed text-[#4a4a4d]">
              {[
                ...
                <li key={i} className="flex gap-2">
                  <span className="mt-2 h-1 w-1 shrink-0 rounded-full bg-[#0F4C81]" />
                  <span>{item}</span>
                </li>
              ))}
            </ul>
              ...
              <div className="sticky top-28">
                  ...
                  {sections.map((s, i) => (
                    <a
                        ...
                        className={`-ml-px flex items-center gap-3 border-l-2 py-2 pl-4 transition-all duration-300 ${
                            activeSection === s.id
                            ? "border-[#0F4C81] bg-[#fff5f5] text-[#0b0b0c] font-semibold"
                            : "border-transparent text-[#4a4a4d] hover:border-[#0F4C81] hover:text-[#0b0b0c]"
                        }`}
                        >
                        <span
                            className={`h-2 w-2 rounded-full transition-all duration-300 ${
                            activeSection === s.id
                                ? "bg-[#0F4C81] opacity-100"
                ...
                <div className="mt-8 rounded-lg border border-[#0b0b0c]/10 bg-[#f7f7f8] p-5">
                  ...
                  <a
                    ...
                    className="mt-3 inline-block font-body text-[13px] font-semibold text-[#0F4C81] hover:underline"
                  >
                    info@lencar.lk
                  </a>
                </div>
              ...
              <section id="cookies" className="scroll-mt-32 border-b border-[#0b0b0c]/10 py-10">
                ...
                <div className="mt-4 space-y-4 font-body text-[15px] leading-relaxed text-[#4a4a4d]">
                  <p>
                    ...
                    cookies, visit{" "}
                    <a href="https://www.aboutcookies.org" className="text-[#0F4C81] hover:underline" target="_blank" rel="noreferrer">
                      aboutcookies.org
                    </a>{" "}
                    or{" "}
                    <a href="https://www.allaboutcookies.org" className="text-[#0F4C81] hover:underline" target="_blank" rel="noreferrer">
                      allaboutcookies.org
                    </a>
                    .
                  </p>
                  ...
                  <ul className="space-y-2 pl-1">
                    {[
                      ...
                      <li key={i} className="flex gap-3">
                        <span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-[#0F4C81]" />
                        <span>{item}</span>
                      </li>
                    ))}
                  </ul>
              ...
              <section id="retention" className="scroll-mt-32 border-b border-[#0b0b0c]/10 py-10">
                ...
                <div className="mt-4 space-y-4 font-body text-[15px] leading-relaxed text-[#4a4a4d]">
                  ...
                  <p>
                    ...
                    <a href="mailto:info@lencar.lk" className="text-[#0F4C81] hover:underline">info@lencar.lk</a>{" "}
              ...
              <section id="contact" className="scroll-mt-32 border-b border-[#0b0b0c]/10 py-10">
                ...
                <div className="mt-5 flex flex-col gap-4 rounded-lg border border-[#0b0b0c]/10 bg-[#f7f7f8] p-6 sm:flex-row sm:items-center sm:justify-between">
                  <div>
                    ...
                    <a href="mailto:info@lencar.lk" className="font-body text-[16px] font-semibold text-[#0b0b0c] hover:text-[#0F4C81]">
                      info@lencar.lk
                    </a>
                  </div>
                  <div>
