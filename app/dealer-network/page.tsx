...
export const metadata = seoMetadata({
  title: "Dealer Network | Lencar",
  description: "Find Lencar dealers and service centers across Sri Lanka. Locate a showroom near you to explore our electric scooters.",
  path: "/dealer-network",
