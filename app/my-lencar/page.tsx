...
import { formatBikePrice } from "@/lib/utils/price_format_helper";

export const metadata = seoMetadata({
  title: "My Lencar | Electric Bike Lineup",
  description: "Explore the Lencar lineup of smart electric scooters. Choose between the eRc 80+ and Zivi — designed for the modern rider.",
  path: "/my-lencar",
  image: "/images/my_lencar.png",
});
  ...
  return (
    <div>
      ...
      <AllPageHero
        ...
        description="Explore our range of smart electric scooter designed for the modern rider."
        imageSrc="/images/my_lencar.png"
      />
      ...
      <main className="bg-white text-[#0b0b0c]">
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20 sm:pb-24 lg:px-8">
          <h2 className="font-display mt-4 max-w-2xl text-[26px] font-black uppercase leading-[1.15] tracking-tight text-[#0b0b0c] sm:text-[30px]">
            FAQ - Questions That Keep You Moving
          </h2>
