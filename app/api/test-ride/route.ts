      ...
      <tr>
        <td align="center">
          <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px; max-width:100%; background-color:#ffffff; border-radius:8px; overflow:hidden;">
            ...
            <tr>
              <td style="background-color:#0f4c81; padding:0; line-height:4px; font-size:4px;">&nbsp;</td>
            </tr>

            <!-- eyebrow + title -->
            <tr>
              <td style="padding:36px 32px 0 32px;">
                <span style="display:block; font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold; letter-spacing:1.5px; text-transform:uppercase; color:#0f4c81;">
                  ${escapeHtml(eyebrow)}
                </span>
...
function ctaButton(label: string, href: string) {
  return `
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin-top:20px;">
      <tr>
        <td style="background-color:#0f4c81; border-radius:4px;">
      ...
      <tr>
        <td style="padding:16px 20px;">
          ...
          <p style="margin:0; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#3a3a3d;">
            <a href="mailto:${email}" style="color:#0f4c81; text-decoration:none;">${escapeHtml(email)}</a>
            &nbsp;&middot;&nbsp;
            <a href="tel:${phone}" style="color:#0f4c81; text-decoration:none;">${escapeHtml(phone)}</a>
          </p>
        </td>
      </tr>
    </table>`;
