        ...
        >
                    ...
                    <div className="flex h-full flex-col-reverse gap-[4px] p-3">
                        {Array.from({ length: PACK_CELLS }).map((_, i) => (
                            <span
                                ...
                                style={{
                                    backgroundColor: docked ? "#0f4c81" : "rgba(255,255,255,0.06)",
            ...
            <div className="absolute bottom-6 left-1/2 flex -translate-x-1/2 items-center gap-2 rounded-full border border-black/[0.08] bg-white px-3 py-1.5 shadow-sm">
                <span
                    ...
                    style={{
                        backgroundColor: docked ? "#0f4c81" : "rgba(0,0,0,0.15)",
            ...
            <div className="relative mx-auto max-w-6xl px-6 py-20 lg:px-8">
                <div className="grid grid-cols-1 gap-14 lg:grid-cols-2 lg:gap-16">
                    ...
                    <div className="flex flex-col justify-center">
                        <p className="font-mono inline-flex w-fit items-center gap-2 text-[12px] font-bold tracking-[0.24em] text-[#0f4c81]">
                            <span className="relative flex h-[7px] w-[7px]">
                                <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#0f4c81] opacity-60" />
                                <span className="relative inline-flex h-[7px] w-[7px] rounded-full bg-[#0f4c81]" />
                            </span>
                            HOME SWAPPING
                        </p>
                            ...
                            {STEPS.map((step, i) => {
                                ...
                                return (
                                    <li key={step.title} className="flex gap-4">
                                        ...
                                        <span className="mt-[1px] text-[#0f4c81]">
                    ...
                    {SPECS.map((spec) => {
                        ...
                        return (
                            <div key={spec.label} className="flex items-center gap-4 px-6 py-6">
                                <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#f7f7f6] text-[#0f4c81]">
                                    <Icon className="h-[18px] w-[18px]" strokeWidth={2.2} />
                                </span>
                                <div>
