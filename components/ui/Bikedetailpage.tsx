        ...
        <section className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 py-16 sm:py-20 lg:grid-cols-2 lg:gap-16 lg:px-8">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-9 flex flex-wrap items-center gap-4">
              <BookTestRideButton
                bikeName={bike.name}
                className="font-body inline-flex items-center justify-center bg-[#0f4c81] px-7 py-3.5 text-[13px] font-semibold uppercase tracking-[0.06em] text-white transition-colors hover:bg-[#c90512]"
              />
              <a
                href="/bikes"
                className="font-body inline-flex items-center justify-center border border-[#0b0b0c] px-7 py-3.5 text-[13px] font-semibold uppercase tracking-[0.06em] text-[#0b0b0c] transition-colors hover:border-[#0f4c81] hover:text-[#0f4c81]"
              >
                Back to lineup
              </a>
            </div>
